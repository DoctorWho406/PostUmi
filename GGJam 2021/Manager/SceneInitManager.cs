...
namespace GGJam_2021 {
    static class SceneInitManager {
        ...
        private static void PortraitLoad() {
            ...
            Portrait portrait4 = new Portrait("Computer", LayerMask.Foreground, Scene.Room, Scene.DialogueComputer, ColliderType.BoxCollider) { Position = new Vector2(1380, 230) };
        ...
        private static void Dialogue() {
            ...
            new Portrait("BackPlayer", LayerMask.Background, Scene.DialogueInit_3, Scene.Room, ColliderType.BoxCollider, 8, 5, 370) { Position = Game.WindowCenter }.Scale(0.7f);
