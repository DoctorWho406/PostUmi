...
namespace GGJam_2021 {
     class InteractableObject : ColliderObject {
        ...
        public InteractableObject(string textureName, LayerMask layerMask, Scene scene, Scene nextScene, ColliderType colliderType, int w = 0, int h = 0, float eulerRotation = 0) : base(textureName, layerMask, scene, colliderType, w, h, eulerRotation) {
